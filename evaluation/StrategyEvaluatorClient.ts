...
export class StrategyEvaluatorClient {
  ...
  private buildEvaluationPrompt(request: EvaluationRequest): string {
    ...
    return [
      ...
      "",
      "When creating suggested strategies, double-check that:",
      "1. Every feature used in rules is declared in the features section",
      "2. Feature names match EXACTLY (including case and underscores)",
      "3. You're declaring the specific variant you need (e.g., macd_histogram, not macd)",
      "",
      "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
