...
export const PERSONA_PROMPTS: Record<string, string> = {
  blackrock_advisor: [
    ...
    "  • If strategy will use rthOnly: true (default) → session: 'rth' (9:30 AM - 4:00 PM ET)",
    "  • If strategy will use rthOnly: false → session: 'all' (includes extended hours)",
    ...
    "  → HARD GATE FAILURE: Entry unreachable during trading hours",
    "  → Recommend: Adjust entry zone OR set rthOnly: false",
    "",
