...
export const PERSONA_PROMPTS: Record<string, string> = {
  blackrock_advisor: [
    ...
    "",
    "4. **Validate & Test** (use MCP tools):",
    "   - validate_strategy({ yaml_content }) - Check syntax and schema compliance",
    "   - backtest_strategy({ yaml_content, historical_data: marketData.bars }) - Test against recent data",
    "   - analyze_strategy_performance({ backtest_results }) - Review metrics",
    "",
